using InstantFood.Pantallas.Restaurantes;
...
public partial class clienteHome : ContentPage
{
    ...
    async void Macdonalds_Tapped(System.Object sender, Microsoft.Maui.Controls.TappedEventArgs e)
    {
        await Navigation.PushAsync(new Macdonalds());
    }
}
